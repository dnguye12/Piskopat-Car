            ...
            <main className="flex-1 mt-[88px]">
                <div className="relative pt-32 lg:pt-60 pb-12">
                    <div className="container mx-auto px-4 relative z-20">
                        <h1 className="text-5xl lg:text-6xl text-main" data-aos="fade-right" data-aos-delay="300">Impressum</h1>
                        <h2 className="text-5xl lg:text-6xl text-neutral-100" data-aos="fade-left" data-aos-delay="300">Transparent und rechtssicher</h2>

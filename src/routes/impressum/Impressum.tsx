            ...
            <main className="flex-1 mt-[88px]">
                <div className="relative pt-32 lg:pt-60 pb-12">
                    <div className="container mx-auto px-4 relative z-20">
                        <h1 className="text-5xl lg:text-6xl text-main" data-aos="fade-right" data-aos-delay="600">Impressum</h1>
                        <h2 className="text-5xl lg:text-6xl text-neutral-100" data-aos="fade-left" data-aos-delay="600">Transparent und rechtssicher</h2>
                    ...
                    <div className="absolute w-full h-full top-0 left-0 z-0 bg-[url('https://i.ibb.co/S4npDd1k/pexels-asphotograpy-515674.jpg')] bg-cover bg-center" data-aos="fade-up" data-aos-delay="200"></div>
                </div>

                <div className="flex flex-col container mx-auto px-4 mt-20 mb-28">

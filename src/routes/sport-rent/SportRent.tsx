            ...
            <main className="flex-1 mt-[88px]">
                <div className="relative pt-32 lg:pt-60 pb-12">
                    <div className="container mx-auto px-4 relative z-20">
                        <h1 className="text-3xl md:text-5xl lg:text-6xl text-main" data-aos="fade-right" data-aos-delay="300">Sportwagen mieten</h1>
                        <h2 className="text-3xl md:text-5xl lg:text-6xl text-neutral-100" data-aos="fade-left" data-aos-delay="300">Kraft und Eleganz in ihrer besten Form mieten</h2>
                    ...
                    <div className="absolute w-full h-full top-0 left-0 z-0 bg-[url('https://images.pexels.com/photos/93632/pexels-photo-93632.jpeg')] bg-cover bg-bottom" data-aos="fade-up" data-aos-delay="100"></div>
                </div>

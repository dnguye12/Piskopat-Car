        ...
        <div className="w-full min-h-screen flex flex-col">
            ...
            <main className="flex-1 mt-[88px]">
                <div className="relative pt-32 lg:pt-60 pb-12">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 z-0 bg-[url('https://images.pexels.com/photos/93632/pexels-photo-93632.jpeg?w=1920')] bg-cover bg-bottom" data-aos="fade-up"></div>
                </div>

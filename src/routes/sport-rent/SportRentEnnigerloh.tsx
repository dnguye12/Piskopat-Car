        ...
        <div className="w-full min-h-screen flex flex-col">
            ...
            <main className="flex-1 mt-[88px]">
                <div className="relative pt-32 lg:pt-60 pb-12">
                    ...
                    <div className="absolute w-full h-full top-0 left-0 z-0 bg-[url('https://i.ibb.co/x8GwMWR8/pexels-mikebirdy-2365572.jpg')] bg-cover bg-center" data-aos="fade-up"></div>
                </div>

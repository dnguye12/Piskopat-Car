...
<div className="container mx-auto px-4 pb-24 h-full relative hidden lg:flex flex-col justify-end z-20">
                ...
                <h1 className="text-6xl text-main" data-aos="fade-left" data-aos-delay="300">Hauptsache Sportwagen</h1>
                <p className="mt-7 text-xl text-neutral-100 max-w-3xl whitespace-pre-wrap break-words" data-aos="zoom-in" data-aos-delay="400">Leistung erkennst du nicht nur an Zahlen – sondern am Sound, am Puls, und dem Moment, in dem die Welt um dich herum stillsteht. Genau dieses Gefühl kannst du bei Monroe Sportwagenvermietung erleben: Luxusfahrzeuge, die begeistern. Ein Premium‒Service, der jeden Moment unvergesslich macht in Kastellaun – und weit darüber hinaus.
                </p>
                <div className="mt-7 grid grid-cols-2 max-w-2xl" >
                    <div className="inline-flex gap-x-2 p-3 items-center" data-aos="fade-right" data-aos-delay="400">
                    ...
                    <div className="inline-flex gap-x-2 p-3 items-center" data-aos="fade-left" data-aos-delay="400">
            ...
            <div className="hidden lg:block absolute top-0 left-0 w-full h-full bg-gradient-to-t from-neutral-900 dark:from-background to-neutral-900/0 z-10 bg-no-repeat bg-center" data-aos="fade-up" data-aos-delay="100"></div>
            <div className="hidden lg:block absolute top-0 left-0 w-full h-full bg-[url('https://i.ibb.co/xSgzRTP3/fb7772b40cf1d5ab756c9cd9b626603b.webp')] bg-cover z-0 bg-no-repeat bg-center" data-aos="fade-up" data-aos-delay="100"></div>

    ...
    return (
        <>
            <div id="vorteile" className="p-6 relative bg-sidebar">
                <div className="grid xl:grid-cols-4 2xl:grid-cols-3 gap-6 container mx-auto lg:px-6">
                    <div className="grid md:grid-cols-2 xl:flex xl:flex-col gap-6" data-aos="fade-right">
                        ...
                        <div className="hidden md:block bg-[url('https://i.ibb.co/v4Q4Bk04/features.jpg')] bg-cover bg-center w-full h-full rounded-lg border"></div>
                    </div>
                    <div className="hidden lg:block xl:col-span-3 2xl:col-span-2 relative border rounded-lg p-8 pt-0 bg-[#050809]" data-aos="fade-left">

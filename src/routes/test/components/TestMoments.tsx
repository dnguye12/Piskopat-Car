        ...
        <section className="container mx-auto px-6 mt-6">
            <div className="grid grid-cols-2 gap-6">
                <div className="flex flex-col p-8 justify-center items-start bg-accent border rounded-lg">
                    <h5 className="text-3xl md:text-4xl text-neutral-100 z-20 mb-4">Dein Moment. Unser Sportwagen.</h5>
                    <h3 className="text-main text-3xl md:text-4xl z-20 font-orbi">Wähle deinen Moment</h3>
                    <p className="text-lg text-muted-foreground my-4 max-w-xl">Dein besonderer Anlass, unser Sportwagen – miete ihn für Hochzeit, Wochenende oder Events.</p>

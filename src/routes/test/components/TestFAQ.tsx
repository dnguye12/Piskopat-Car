...
const FaqAccordion = ({ index, question, content }: FaqAccordionProps) => {
    return (
        <AccordionItem value={`item-${index}`} className="border rounded-lg p-4 lg:p-6 mt-4 lg:mt-6 shadow-md bg-accent" data-aos="fade-up">
...
const TestFaq = () => {
    return (
        <section className="container mx-auto mt-6 px-6 mb-20">

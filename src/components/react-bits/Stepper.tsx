...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`w-full h-full  ${stepCircleContainerClassName}`}
      >
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "var(--sidebar)", color: "var(--muted-foreground)" },
          active: { scale: 1, backgroundColor: "var(--main)", color: "var(--main)" },
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "var(--main)" },
  };
